...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Enquiry.created_by'
        db.alter_column('enquiry_enquiry', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Enquiry.created_by'
        raise RuntimeError("Cannot reverse this migration. 'Enquiry.created_by' and its values cannot be restored.")
