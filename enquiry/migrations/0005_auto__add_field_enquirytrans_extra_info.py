...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnquiryTrans.extra_info'
        db.add_column('enquiry_enquirytrans', 'extra_info',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnquiryTrans.extra_info'
        db.delete_column('enquiry_enquirytrans', 'extra_info')
